---
title: 'A világóra: hogyan fér rá az egész bolygó egy számlapra'
...
draft: false
model:
  src: '/widgets/vilagora.html'
  title: 'A világóra működés közben'
  description: 'Válassz egy várost, és figyeld meg, hogyan fordul helyére a városgyűrű és a huszonnégy órás nappal–éjszaka korong.'
  level: 'intermediate'
cover:
  src: '../_images/vilagora-hero-hu.png'
  cardSrc: '../_images/vilagora-card-hu.png'
  alt: 'Világóra világtérképes számlappal és huszonnégy időzónás gyűrűvel, magyar címmel'
  focus: 'center center'
  credit: 'Lume · AI'
sources:
  - label: "SJX Watches: In Depth, Louis Cottier's Legacy"
  - label: 'Collectability: Inside the Movement, Louis Cottier'
  - label: 'Oracle of Time: Why Louis Cottier is the Father of World Time Wristwatches'
  - label: 'Revolution: Patek Philippe World Time, Romancing the World'
  - label: 'Europa Star: World time, Patek Philippe and Louis Cottier'
  - label: 'Deployant: The History of the World as told by World Time Watches'
  - label: 'MR PORTER: A History of World Timer and GMT Watches'
---
...
<iframe src="/widgets/vilagora.html" title="Interaktív világóra-modell" width="100%" height="820" style="border:0; border-radius:6px;" loading="lazy"></iframe>
