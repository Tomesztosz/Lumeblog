---
title: 'A G-Shock: miért nem elég hozzá egy vastag gumitok'
description: 'A G-Shock nem egyszerűen egy kvarcóra vastag műanyagba csomagolva. A tok formája, az üreges belső tér és a párnázott modul együtt vezeti el az ütést.'
seoTitle: 'G-Shock ütésállóság: ezért nem elég a vastag gumitok'
seoDescription: 'Hogyan védi meg a G-Shock a kvarcmodult eséskor? Az üreges tok, a rugalmas támaszok és a többrétegű ütésvédelem működése interaktív modellen.'
date: 2026-08-28
column: 'movement'
lang: 'hu'
slug: 'g-shock-utestallo-technologia'
translationKey: 'g-shock-technologia'
minutes: 10
draft: false
model:
  src: '/widgets/g-shock.html'
  title: 'Mi történik, amikor földet ér a G-Shock?'
  description: 'Ejtsd le ugyanazt az órát merev és párnázott belső rögzítéssel, majd hasonlítsd össze, mennyi terhelés jut el a modulig.'
  level: 'foundation'
cover:
  src: '../_images/g-shock-hero-hu.png'
  cardSrc: '../_images/g-shock-card-hu.png'
  alt: 'Eredeti formájú fekete G-Shock műszaki tokmetszet előtt, magyar címmel'
  focus: 'center'
  credit: 'Lume · Casio archívum · AI'
  creditUrl: 'https://world.casio.com/development/'
sources:
  - label: 'Casio: G-Shock Development Story — a gumilabda ötlete, az üreges szerkezet és a fejlesztés története'
    url: 'https://world.casio.com/development/'
  - label: 'Casio: Shock Resistance Technology — az üreges tok, a kritikus alkatrészek csillapítása és a minden irányú védelem'
    url: 'https://gshock.casio.com/za/technology/shock/'
  - label: 'Casio: G-Shock 5000/5600 — az egymondatos javaslat, a háromfős csapat és az eredeti konstrukció'
    url: 'https://gshock.casio.com/intl/products/collection/origin/5000_5600/'
  - label: 'Casio: Product History — a DW-5000C 1983-as megjelenése és 200 méteres vízállósága'
    url: 'https://world.casio.com/corporate/history/chronology/'
  - label: 'Casio: Brand Philosophy — Triple G Resist, teljesen fém szerkezet és Carbon Core Guard'
    url: 'https://gshock.casio.com/intl/about/philosophy/'
  - label: 'Casio: G-Shock Identity — több mint kétszáz prototípus és két év fejlesztés'
    url: 'https://gshock.casio.com/us/identity/'
  - label: 'Casio: GA-2100 catalogue — a Carbon Core Guard robbantott ábrája és műszaki leírása'
    url: 'https://gshock.casio.com/content/dam/casio/global/watch/g_shock/catalog/ENG_GA-2100_catalog.pdf'
  - label: 'Casio Corporate Report 2015 — Kikuo Ibe visszaemlékezése és a harmadik emeleti ejtési próbák'
...
![A klasszikus négyzetes G-Shock egy korai műszaki rajz fölött](../_images/g-shock-dw5000c.jpg)
...
![A hagyományos és az üreges G-Shock-tok terhelési útjának összehasonlítása](../_images/g-shock-hollow-case.jpg)
...
![A G-Shock minden irányú külső védelmének rajza](../_images/g-shock-all-directions.jpg)
...
![A GA-2100 Carbon Core Guard szerkezetének robbantott ábrája](../_images/g-shock-ga2100-carbon-core.png)
