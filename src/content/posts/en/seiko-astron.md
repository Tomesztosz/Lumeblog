---
title: "The watch that started the quartz revolution on Christmas Day"
description: "On Christmas Day 1969, Seiko released a gold watch that cost as much as a car. The Quartz Astron still changed the entire watch industry."
seoTitle: "Seiko Quartz Astron: the watch that started the quartz revolution"
seoDescription: "The story of the 1969 Seiko Quartz Astron: ten years of development, a car-sized price and the technology that rewrote Swiss watchmaking."
date: 2026-08-26
column: 'origins'
lang: 'en'
slug: 'seiko-quartz-astron-history'
translationKey: 'seiko-quartz-astron'
minutes: 11
draft: false
cover:
  src: '../_images/seiko-astron-hero.png'
  cardSrc: '../_images/seiko-astron-card.png'
  alt: 'The gold 1969 Seiko Quartz Astron with quartz-resonator and circuit drawings'
  focus: 'center center'
  credit: 'Lume — original composition based on a Seiko archival photograph, with AI assistance'
  creditUrl: 'https://www.seikowatches.com/global-en/products/astron/special/story_qa50th_1'
sources:
  - label: 'Seiko: The Story of 1969 Quartz Astron — Project 59A, the development race, the 35SQ technology, its release and early production'
    url: 'https://www.seikowatches.com/global-en/products/astron/special/story_qa50th_1'
  - label: 'The Seiko Museum Ginza: The birth of the quartz timepiece — broadcasting clocks, Olympic timing and the development timeline'
    url: 'https://museum.seiko.co.jp/en/knowledge/Quartz01/'
  - label: 'Seiko 100 Stories: Innovation — miniaturisation, the Calibre 35A, accuracy, case finishing and Seiko’s patent policy'
    url: 'https://www.seikowatches.com/us-en/special/100stories/innovation/'
  - label: 'Seiko Watch Design: The Astron — the original Astron’s design and movement photographs'
    url: 'https://www.seiko-design.com/en/stories-en/astron-en/'
  - label: 'Smithsonian Institution: Seiko Quartz Wristwatch — the opening production run, price, hybrid circuit and the Astron’s historical significance'
    url: 'https://www.si.edu/object/nmah_1204788'
  - label: 'Federation of the Swiss Watch Industry: The Swiss watch industry today — Swiss watch-industry employment during the quartz crisis'
    url: 'https://www.fhs.swiss/eng/watchindustrytoday.html'
  - label: 'Epson: Seiko Quartz Astron 35SQ — Suwa Seikosha’s development and the Astron’s place in industrial history'
