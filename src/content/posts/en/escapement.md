---
title: 'The escapement: that sound is what makes a watch a watch'
description: 'The real trick of a mechanical watch is not that it runs, but that it runs slowly. The whole job is done by a cluster of parts the size of a fingernail, saying yes and no eight times a second.'
seoTitle: 'Watch Escapements: How Mechanical Ticking Works'
seoDescription: 'How does a mechanical watch escapement work? Explore the balance, pallet fork and escape wheel through an interactive model.'
date: 2026-08-14
column: 'movement'
lang: 'en'
...
sources:
  ...
  - label: 'Seiko Museum Ginza: the lever escapement and club-shaped teeth'
  - label: 'Set Back In Time: the escapement, Thomas Mudge and the English–Swiss differences'
  - label: 'Rotate Watches: the four phases of the escapement and beat rates'
  - label: 'Horopedia: the phases of the Swiss lever escapement'
  - label: 'Oracle of Time: portrait of Thomas Mudge'
...
![Thomas Mudge, English watchmaker](../_images/thomas-mudge.jpg)
