---
title: 'The world timer: how the whole planet fits on one dial'
...
model:
  ...
  title: 'The world timer in motion'
  description: 'Choose a city and see how the city ring and the twenty-four-hour day–night disc turn into position.'
  level: 'intermediate'
cover:
  src: '../_images/vilagora-hero-en.png'
  cardSrc: '../_images/vilagora-card-en.png'
  alt: 'A world timer with a map dial and twenty-four-zone ring, with an English title'
  focus: 'center center'
  credit: 'Lume · AI'
sources:
...
<iframe src="/widgets/vilagora.html?lang=en" title="Interactive world timer model" width="100%" height="820" style="border:0; border-radius:6px;" loading="lazy"></iframe>
